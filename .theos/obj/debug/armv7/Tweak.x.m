...
-(SBIconView*)initWithContentType:(int)size;
@end
...
@class SBApplicationIcon; @class SBIconView; @class SBApplicationController; @class SBHomeScreenViewController; 
...
static void _logos_method$_ungrouped$SBHomeScreenViewController$onSwipeUp$(_LOGOS_SELF_TYPE_NORMAL SBHomeScreenViewController* _LOGOS_SELF_CONST __unused self, SEL __unused _cmd, UIGestureRecognizer* sender) {
	...
	SBApplication *app = [[_logos_static_class_lookup$SBApplicationController() sharedInstance] applicationWithBundleIdentifier:bundleIds[3]];
	SBApplicationIcon *appIcon = [[_logos_static_class_lookup$SBApplicationIcon() alloc] initWithApplication:app];
	SBIconView *iconView = [[_logos_static_class_lookup$SBIconView() alloc] initWithContentType:0]; 
	SBHomeScreenViewController* controller = MSHookIvar<SBHomeScreenViewController*>(self, "_iconController");
